...
function FooterTop() {
    return (
        <div className="flex flex-col gap-5 justify-around items-center text-center py-10 lg:flex-row lg:gap-0">
            ...
            <address className="flex flex-col gap-2 w-full text-center pl-responsive-padding-x sm:w-auto sm:pl-0">
            ...
            <address className="flex flex-col gap-2 text-center w-full pl-responsive-padding-x sm:w-auto sm:pl-0">
